...
Options:
- Upgrade dependencies only within repository policy and supported compatibility, then verify the migration
...
- Isolate the blocked migration area and document the dependency; do not weaken repository-wide checks merely
