---
description: Investigates a scoped question in isolation and returns a tight summary, not a raw dump. Use for unfamiliar code, "how does X work", or gathering context before planning.
mode: subagent
permission:
  edit: deny
---
